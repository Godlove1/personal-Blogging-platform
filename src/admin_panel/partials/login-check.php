<?php
    ...
    if(!isset($_SESSION['user']))  {
        ...
        $_SESSION['login'] ='
         <div class="w-auto bg-orange-100 border-t-4 border-orange-500 rounded-b text-orange-700 px-4 py-3 shadow-md" role="alert">
        <div class="flex">
          ...
          <div>
            <p class="font-bold">Login As Admin </p>
            <p class="text-sm">Please Login to access  page.</p>
          </div>
        </div>
      </div>';
