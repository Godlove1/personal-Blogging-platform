...
<div class="w-full flex justify-center items-center my-8">
	...
	<li><button class="<?php if($page_no <= 1){ echo "disabled"; } ?> h-10 px-3 text-black transition-colors duration-150 bg-white border border-r-0 border-black rounded-l-lg focus:shadow-outline hover:bg-slate-500">
	...
	if ($total_no_of_pages <= 10){
		for ($counter = 1; $counter <= $total_no_of_pages; $counter++){
			if ($counter == $page_no) {
		   echo "<li><button class='h-10 px-3 text-white transition-colors duration-150 bg-black border border-r-0 border-black hover:bg-slate-500'><a>$counter</a></button></li>";
				}else{
...
?>
    ...
    <?php if($page_no < $total_no_of_pages){
		echo "<li><button class='h-10 px-3 text-black transition-colors duration-150 bg-white border border-black rounded-r-lg focus:shadow-outline hover:bg-slate-500'><a class='font-bold' href='?page_no=$total_no_of_pages'>Last</a></button></li>";
		} ?>
