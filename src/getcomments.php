...
<div  class="comment my-4 p-2 lg:w-[400px]">
    ...
    <?php echo $comment_content; ?>
        ...
        <!-- <div class="rep w-[250px] my-2">
            <p id="reply" class="hover:text-red-500 cursor-pointer">reply<i class="fa-solid ml-2 fa-reply"></i></p>
        </div> -->
        <!-- replytextbox-->
        <!-- <div class="tbox">
            <form action="" method="post" class="flex justify-center items-center">
                ...
                <!-- <input type="submit" value="send" name="reply" class="bg-red-500 text-white px-4 w-[100px] ml-2 rounded-md hover:bg-white hover:text-red-500">
            </form>
        </div> -->
            <!-- admins reply -->
            <!-- <div class="areply">
              <p class="text-xs italic">from author:</p>
              <p class="italic text-sm text-red-500 text-left">
