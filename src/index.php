...
$sql = "SELECT * FROM tbl_blog_posts WHERE post_status=1 order by rand() LIMIT 15";
//Execute the qUery
...
<div class=" border-[#921125] border-8 lg:border-none bg-[#121418] text-white  p-4 mb-8">
